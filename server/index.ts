  ...
  if (!isProd) {
    ...
    const vite = await createViteServer({
      ...
      server: {
        ...
        // and point the client at the HTTPS preview proxy (wss on 443) so it
        // connects on the first try instead of retrying wrong URLs.
        hmr: { server: httpServer, protocol: "wss", clientPort: 443 },

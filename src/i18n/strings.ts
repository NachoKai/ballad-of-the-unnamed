...
const en: StringMap = {
  ...
  seasonFameGain: "Fame earned",
  seasonReputationGain: "Renown earned",
  ...
  locked: "Locked",
  masterArchetype: "Master Archetype",
  masterArchetypeLocked: "Finish a run with this class to unlock",
  newArchetypeUnlocked: "New archetype unlocked!",
  ...
  archetype_juggernaut: "Juggernaut",
  archetype_gladiator: "Gladiator",
  archetype_ironclad: "Ironclad",
  archetype_geomancer: "Geomancer",
  archetype_stormcaller: "Stormcaller",
  archetype_abjurer: "Abjurer",
  archetype_chronomancer: "Chronomancer",
  archetype_charlatan: "Charlatan",
  archetype_poisoner: "Poisoner",
  archetype_trapmaster: "Trapmaster",
  archetype_acrobat: "Acrobat",
  archetype_crime_lord: "Crime Lord",
  archetype_pathfinder: "Pathfinder",
  archetype_warden: "Warden",
  archetype_beastcaller: "Beastcaller",
  archetype_stoneborn: "Stoneborn",
  archetype_exorcist: "Exorcist",
  archetype_crusader: "Crusader",
  archetype_heretic: "Heretic",
  archetype_griot: "Griot",
  archetype_swashbuckler: "Swashbuckler",
  archetype_dirgesinger: "Dirgesinger",
  archetype_warlord: "Warlord",
  archetype_archmage: "Archmage",
  archetype_phantom: "Phantom",
  archetype_beastlord: "Beastlord",
  archetype_avatar: "Avatar",
  archetype_maestro: "Maestro",
  ...
  minigameVs: "vs",
  minigameHowTo: "How to play",
  minigameClose: "Close",
  rpsRock: "Stone",
  rpsPaper: "Parchment",
  rpsScissors: "Dagger",
  rpsLizard: "Salamander",
  rpsSpock: "Mage",
  rpsRound: "Round",
  rpsScore: "Score",
  ...
  rpsTieRound: "A tie.",
  rpsHowTitle: "The Five Hand-Signs",
  rpsHowIntro: "Each sign defeats two others and loses to two. First to two rounds wins.",
  rpsHowStone: "Stone crushes Dagger and Salamander",
  rpsHowParchment: "Parchment covers Stone and silences the Mage",
  rpsHowDagger: "Dagger cuts Parchment and skewers Salamander",
  rpsHowSalamander: "Salamander devours Parchment and burns the Mage",
  ...
  memMatched: "You found a pair!",
  memMissed: "No match — the tiles turn back.",
  memRivalMatched: "Your rival found a pair.",
  memRivalMissed: "Your rival missed.",
  memFaceDragonEgg: "Dragon's Egg",
  memFaceSword: "Sword",
  memFaceCrown: "Crown",
  memFacePotion: "Potion",
  memFacePhoenix: "Phoenix",
  memFaceShield: "Shield",
  memFaceScroll: "Scroll",
  memFaceGem: "Gem",
  ...
  pressResultWin: "A flawless read.",
  pressResultPartial: "A mixed read.",
  pressResultLose: "You misread the room.",
  pressWanted: "Wanted",
  pressHowTitle: "The Press Room",
  pressHowIntro:
    "Three questions, four answers each. The interviewer favors what your history already whispers — and fame and charisma bend their ear further.",
  pressTranscript: "How it landed",
  wheelHowTitle: "The Wheel of Fortune",
  wheelHowIntro:
    "Pay to spin the carnival wheel. Land on gold, a prize, or a free spin — or nothing at all. The jackpot makes the night; walk away while your luck holds.",
  wheelSpin: "Spin the wheel",
  wheelFreeSpin: "Free spin",
  wheelCashOut: "Cash out",
  wheelSpins: "Spins",
  wheelNet: "Net",
  wheelYouWon: "You won",
  wheelNothing: "Nothing — the wheel laughs.",
  wheelJackpot: "JACKPOT!",
  wheelMysteryPrize: "The box bursts open — treasure spills out!",
  wheelMysteryInjury: "The box snaps shut — a hidden spring-trap bites you!",
  wheelNoFunds: "Not enough gold",
  ...
  combatResistance: "Resistance",
  combatRarity_common: "Common",
  combatRarity_uncommon: "Uncommon",
  combatRarity_rare: "Rare",
  combatRarity_elite: "Elite",
  combatRarity_boss: "Boss",
  combatMenaceProgress: "{kills}/{target} slain to lift it",
...
const es: StringMap = {
  ...
  seasonFameGain: "Fama ganada",
  seasonReputationGain: "Renombre ganado",
  ...
  locked: "Bloqueado",
  masterArchetype: "Arquetipo Maestro",
  masterArchetypeLocked: "Completá una vida con esta clase para desbloquear",
  newArchetypeUnlocked: "¡Nuevo arquetipo desbloqueado!",
  ...
  archetype_juggernaut: "Ariete",
  archetype_gladiator: "Gladiador",
  archetype_ironclad: "Coraza de Hierro",
  archetype_geomancer: "Geomante",
  archetype_stormcaller: "Invocador de Tormentas",
  archetype_abjurer: "Abjurador",
  archetype_chronomancer: "Cronomante",
  archetype_charlatan: "Charlatán",
  archetype_poisoner: "Envenenador",
  archetype_trapmaster: "Maestro de Trampas",
  archetype_acrobat: "Acróbata",
  archetype_crime_lord: "Señor del Crimen",
  archetype_pathfinder: "Abridor de Caminos",
  archetype_warden: "Guardián del Bosque",
  archetype_beastcaller: "Llamador de Bestias",
  archetype_stoneborn: "Nacido de la Piedra",
  archetype_exorcist: "Exorcista",
  archetype_crusader: "Cruzado",
  archetype_heretic: "Hereje",
  archetype_griot: "Griot",
  archetype_swashbuckler: "Espadachín",
  archetype_dirgesinger: "Cantor de Endechas",
  archetype_warlord: "Caudillo",
  archetype_archmage: "Archimago",
  archetype_phantom: "Fantasma",
  archetype_beastlord: "Señor de las Bestias",
  archetype_avatar: "Avatar",
  archetype_maestro: "Maestro",
  ...
  minigameVs: "vs",
  minigameHowTo: "Cómo se juega",
  minigameClose: "Cerrar",
  rpsRock: "Piedra",
  rpsPaper: "Pergamino",
  rpsScissors: "Daga",
  rpsLizard: "Salamandra",
  rpsSpock: "Mago",
  rpsRound: "Ronda",
  rpsScore: "Marcador",
  ...
  rpsHowSalamander: "La Salamandra devora el Pergamino y abrasa al Mago",
  ...
  memMatched: "¡Encontraste un par!",
  memMissed: "No es par — las losetas vuelven a ocultarse.",
  memRivalMatched: "Tu rival encontró un par.",
  memRivalMissed: "Tu rival falló.",
  memFaceDragonEgg: "Huevo de Dragón",
  memFaceSword: "Espada",
  memFaceCrown: "Corona",
  memFacePotion: "Poción",
  memFacePhoenix: "Fénix",
  memFaceShield: "Escudo",
  memFaceScroll: "Pergamino",
  memFaceGem: "Gema",
  ...
  pressQuestion: "Pregunta",
  pressResultWin: "Una lectura impecable.",
  pressResultPartial: "Una lectura mixta.",
  pressResultLose: "Leíste mal la sala.",
  pressWanted: "Buscaba",
  pressHowTitle: "La Sala de Prensa",
  pressHowIntro:
    "Tres preguntas, cuatro respuestas cada una. El entrevistador favorece lo que tu historia ya susurra — y la fama y el carisma inclinan aún más su oído.",
  pressTranscript: "Cómo cayó",
  wheelHowTitle: "La Rueda de la Fortuna",
  wheelHowIntro:
    "Pagá para girar la rueda del carnaval. Podés ganar oro, un premio o una tirada gratis — o nada en absoluto. El pozo mayor corona la noche; retirate mientras la suerte te sonría.",
  wheelSpin: "Girar la rueda",
  wheelFreeSpin: "Tirada gratis",
  wheelCashOut: "Cobrar",
  wheelSpins: "Tiradas",
  wheelNet: "Saldo",
  wheelYouWon: "Ganaste",
  wheelNothing: "Nada — la rueda se ríe.",
  wheelJackpot: "¡JACKPOT!",
  wheelMysteryPrize: "¡La caja se abre de golpe — el tesoro se derrama!",
  wheelMysteryInjury: "¡La caja se cierra de golpe — una trampa oculta te muerde!",
  wheelNoFunds: "No alcanza el oro",

  // Encuentros de combate.
  combatDefend: "Defender",
  combatFlee: "Huir",
  combatRound: "Ronda",
  combatVictory: "Victoria",
  combatDefeat: "Derrota",
  combatFled: "Huiste",
  combatSpoils: "Botín",
  combatLog: "El combate",
  combatYouStrike: "Golpeás a {creature} por {dmg}",
  combatYouCrit: "¡Golpe crítico por {dmg}!",
  combatYouUse: "Usás {ability}",
  combatYouHeal: "Recuperás {n} de salud",
  combatYouSteal: "Sustraés {n} de oro",
  combatYouDefend: "Te preparás para el golpe",
  combatYouFlee: "Intentás huir",
  combatYouFled: "¡Escapás!",
  combatCreatureUses: "{creature} usa {move} por {dmg}",
  combatCreatureHeals: "{creature} recupera {n} de salud",
  combatCreatureFled: "¡{creature} huye!",
  combatCreatureSkipped: "{creature} está aturdida y no puede actuar",
  combatPoisonTick: "{creature} sufre {n} de veneno",
  combatResultWin: "¡Derrotaste a {creature}!",
  combatResultLose: "Fuiste derrotado por {creature}",
  combatResultFled: "Huiste de {creature}",
  combatStatus_poisoned: "Envenenado",
  combatStatus_slowed: "Ralentizado",
  combatStatus_enraged: "Enfurecido",
  combatStatus_stunned: "Aturdido",
  combatStatus_guarding: "En guardia",
  combatStatus_attack_up: "Ataque +",
  combatStatus_attack_down: "Ataque −",
  combatStatus_defense_up: "Defensa +",
  combatStatus_smoke: "Humo",
  combatLocked: "Bloqueado",
  combatResource: "Recurso",
  combatYou: "Tú",
  combatAttack: "Ataque",
  combatDefense: "Defensa",
  combatResistance: "Resistencia",
  combatRarity_common: "Común",
  combatRarity_uncommon: "Inusual",
  combatRarity_rare: "Rara",
  combatRarity_elite: "Élite",
  combatRarity_boss: "Jefe",
  combatMenaceProgress: "{kills}/{target} abatidos para levantarla",
